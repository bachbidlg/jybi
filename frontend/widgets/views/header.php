        ...
        <div class="d-flex justify-content-between align-items-center position-relative">
            ...
            <nav id="menu" class="main-menu">
                <ul class="nav">
                    ...
                    <li class="top-lang">
                        <a href="#" onClick="doGTranslate('en|vi');return false;" title="English"
                           class="gflag nturl"><img src="/images/vietnam.png" height="32" width="32" alt="English"/></a>
                        <a href="#" onClick="doGTranslate('vi|en');return false;" title="Vietnamese"
                           class="gflag nturl"><img src="/images/united-kingdom.png" height="32" width="32"
                                                    alt="Vietnamese"/></a>
                    </li>
                </ul>
            </nav>
...
<?php
$arr_icons = [];
if ($shop != null && $shop->dataMetadata('phone') != null) $arr_icons[] = [
    'href' => 'tel: ' . $shop->dataMetadata('phone'),
    'title' => '',
    'icon' => '<i class="fa fa-phone"></i>'
];
if ($shop != null && $shop->dataMetadata('email') != null) $arr_icons[] = [
    'href' => 'mailto: ' . $shop->dataMetadata('email'),
    'title' => '',
...
if (count($socials) > 0) {
    foreach ($socials as $social) {
        ...
        if ($icon != null) {
            $arr_icons[] = [
                'href' => $social->url != null ? $social->url : '#',
                'title' => $social->name,
                'icon' => $icon
            ];
        }
...
<div id="menu-sidebar" class="menu menu-sidebar">
    <div class="menu-scroll">
        <?php if (count($arr_icons) > 0) { ?>
            <div class="sidebar-socials row-cols-<?= count($arr_icons) ?>">
                <?php foreach($arr_icons as $icon){ ?>
                    <a class="col" href="<?= $icon['href'] ?>" title="<?= $icon['title'] ?>" target="_blank">
                        <?= $icon['icon'] ?>
                    </a>
                <?php } ?>
            </div>
        ...
        <?php } ?>
        <?php if ($shop != null && $shop->imageExist('logo', 'logo')) { ?>
            <a class="sidebar-logo" href="<?= Url::home() ?>" title="<?= $shop->dataMetadata('name') ?>"
               style="background-image: url(<?= $shop->getImage('logo', 'logo') ?>)">
            </a>
        <?php } ?>
        ...
        <a class="menu-item flag-vi" href="#" onClick="doGTranslate('en|vi');return false;" title="English"
           class="gflag nturl">
            <img src="/images/vietnam.png" height="32" width="32" alt="English"/>
        </a>
        <a class="menu-item flag-en" href="#" onClick="doGTranslate('vi|en');return false;" title="Vietnamese"
           class="gflag nturl">
