                        ...
                        <div class="col-sm">
                            <div class="table-wrap">
                                <div class="dataTables_wrapper dt-bootstrap4">
                                    ...
                                    ',
                                        'pager' => [
                                            'firstPageLabel' => ShopModule::t('shop', 'First'),
                                            'lastPageLabel' => ShopModule::t('shop', 'Last'),
                                            'prevPageLabel' => ShopModule::t('shop', 'Previous'),
                                            'nextPageLabel' => ShopModule::t('shop', 'Next'),
                                            'maxButtonCount' => 5,
                                        ...
                                        'columns' => [
                                            ...
                                            [
                                                ...
                                                'header' => ShopModule::t('shop', 'Actions'),
                                                'template' => '{update} {delete}',
                                                'buttons' => [
                                                    'update' => function ($url, $model) {
                                                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>', $url, [
                                                            'title' => ShopModule::t('shop', 'Update'),
                                                            'alia-label' => ShopModule::t('shop', 'Update'),
                                                            'data-pjax' => 0,
                                                    ...
                                                    'delete' => function ($url, $model) {
                                                        return Html::a('<span class="glyphicon glyphicon-trash"></span>', 'javascript:;', [
                                                            'title' => ShopModule::t('shop', 'Delete'),
                                                            'class' => 'btn btn-danger btn-xs btn-del',
                                                            'data-title' => ShopModule::t('shop', 'Delete?'),
                                                            'data-pjax' => 0,
                                                            'data-url' => $url,
