...
namespace milkyway\label\controllers;
...
use milkyway\label\models\search\LabelSearch;

/**
 * LabelController implements the CRUD actions for Label model.
 */
class LabelController extends MyController
{
    /**
    * {@inheritdoc}
    */
    ...
    */
    public function actionView($label, $language_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($label, $language_id),
        ]);
    }
    ...
    */
    ...
    protected function findModel($label, $language_id)
    {
        if (($model = Label::findOne(['label' => $label, 'language_id' => $language_id])) !== null) {
            return $model;
        }

        throw new NotFoundHttpException(Yii::t('label', 'The requested page does not exist.'));
    }
}
