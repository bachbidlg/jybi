...
class m200704_040528_create_table_news_category extends Migration
{
    ...
    public function safeUp()
    {
        ...
        if ($check_table_language === null) {
            ...
            $this->addForeignKey('news_category_language-news_category_id-news_category-id', 'news_category_language', 'news_category_id', 'news_category', 'id', 'RESTRICT', 'CASCADE');
            $this->addForeignKey('news_category_language-language_id-language-id', 'news_category_language', 'language_id', 'language', 'id', 'RESTRICT', 'CASCADE');
        }
    }
