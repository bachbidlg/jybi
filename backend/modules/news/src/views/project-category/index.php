...
$this->title = NewsModule::t('news', 'Projects Categories');
...
//                                                        'target' => '_blank',
                                            ...
                                            [
                                                ...
                                                'format' => 'raw',
                                                'value' => function ($model) {
                                                    return '<input type="checkbox" class="ipt-checkbox" ' . ($model->status ? 'checked' : '') . ' data-field="status" data-id="' . $model->id . '" data-url="' . Url::toRoute(['change-value']) . '" data-checked="' . NewsCategoryTable::STATUS_PUBLISHED . '" data-unchecked="' . NewsCategoryTable::STATUS_DISABLED . '">';
                                                }
                                            ],
                                            [
                                                'attribute' => 'menu_main',
